...
<script type="text/javascript" src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template?>/rokzoom/rokzoom.js"></script>
	...
	<div style=" background-image:url(<?php echo $this->baseurl; ?>/images/footer.jpg) ; height:90px;">
		<div style="height:100px; margin-left:260px; color: #CCC;">
		  <li style="font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif; font-size: 9px; color: #060; text-align: left; float:none; list-style-type: none; margin-top:30px"><img src="<?php echo $this->baseurl; ?>/images/logo2.png" width="40" height="36" /></li>
		<li style="font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif; font-size: 10px; color: #FFF; text-align: left; float:none; list-style-type: none; margin-top:0px">Caja de Jubilaciones y Pensiones de Empleados de Bancos y Afines del Paraguay &copy; 2012 - Todos los Derechos Reservados</li>
		<li style="font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif; font-size: 10px; color: #FFF; text-align: left; float:none; list-style-type: none;"><a href="http://webmail.cajabancaria.gov.py" style="font-size:10px; color:#ffffff">Webmail</a> | <a href="http://www.cajabancaria.gov.py/v2" style="font-size:10px; color:#ffffff">www.cajabancaria.gov.py </a> | Humaita 357 e/Chile y Alberdi |(595 21) 492 051 / 052 / 053 / 054</li>  
      </div>
   	</div>
