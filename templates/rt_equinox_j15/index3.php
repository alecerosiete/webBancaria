...
<script type="text/javascript" src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template?>/rokzoom/rokzoom.js"></script>
	...
	<div style=" background-image:url(<?php echo $this->baseurl; ?>/images/footer.jpg) ; height:90px;">
		<div style="height:90px; margin-left:260px; color: #CCC;">
		  <li style="font-family: Arial, Helvetica, sans-serif; font-size: 9px; color: #060; text-align: justify; float:none; list-style-type: none; margin-top:30px"><img src="<?php echo $this->baseurl; ?>/images/logo2.png" width="40" height="36" /></li>
		<li style="font-family: Arial, Helvetica, sans-serif; font-size: 9px; color: #FFF; text-align: justify; float:none; list-style-type: none; margin-top:0px">Caja de Jubilaciones y Pensiones de Empleados de Bancos y Afines del Paraguay &copy; 2009 - Todos los Derechos Reservados</li>
